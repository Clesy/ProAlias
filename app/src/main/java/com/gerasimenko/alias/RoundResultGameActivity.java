...
//
//class RoundResultsGameActivity extends AppCompatActivity {
//
...
//                    Toast.makeText(RoundResultsGameActivity.this, msg, Toast.LENGTH_SHORT).show();
//                }
...
//                    @Override
//                    public void onClick(DialogInterface dialogInterface, int i) {
//                        Intent intent = new Intent(RoundResultsGameActivity.this, MainActivity.class);
//                        startActivity(intent);
//                    }
...
//            Context wrapper = new ContextThemeWrapper(RoundResultsGameActivity.this, R.style.PopupMenu);
